...
public class PandoraTestContainer extends TestContainer {

    public PandoraTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/pandora/app.properties",
    ...
    public static class Common extends PandoraTestContainer {

        public static final PandoraTestContainer.Common INSTANCE = new PandoraTestContainer.Common();
